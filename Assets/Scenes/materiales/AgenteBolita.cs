    ...
    void Update()
    {
        ...
        if(estado ==3) //buscaPareja
        {
            ...
            foreach(AgenteBolita a in manager.agentes){
                if((a.energia>= energiaPareja && a.id!=id)|| a.energia <500){
        ...
        { //persigue pareja
            if(parejaSeleccionada != null){
                ...
                if(parejaSeleccionada.energia<1000){
                    Debug.DrawLine(transform.position, parejaSeleccionada.transform.position, Color.red);
                }
                if(parejaSeleccionada.energia>1000){
                    Debug.DrawLine(transform.position, parejaSeleccionada.transform.position, Color.white);
                }
                ...
                {
                    estado=5;
                }else if (Vector3.Magnitude(posPareja-transform.position)<
                5f&&parejaSeleccionada.energia<1000){
                    estado = 6; 
                }
            }
            else{
